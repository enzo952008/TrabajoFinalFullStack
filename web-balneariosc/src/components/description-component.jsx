    ...
    return (
        <div className="tourist-attraction-container">
            <div className="text-content">
                <p>
                    Este lugar es un oasis de calma y belleza natural, ideal para aquellos que buscan desconectarse del ajetreo diario.
                    ...
                    conectarte con la naturaleza y encontrar un profundo sentido de serenidad.
                </p>
            </div>
